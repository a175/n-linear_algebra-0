...
\newtheorem{numberedanswer}[thm]{略解}

\renewcommand{\callbackToAnnounceProveLater}[1]{%
  \marginpar{証明は\cref{#1}.}%
}
...
\newnumberedproof{proofof}{numberedproof}
\newnumberedproof{answerof}{numberedanswer}
% Cref
...
\newcommand{\numof}[1]{\left|#1\right|}
%\newcommand{\numof}[1]{\#{#1}}
\newcommand{\defit}[1]{\index{#1}\emph{#1}}
