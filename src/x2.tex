...
\newcommand{\provelater}[1]{\makebox{}\label{statement:#1}\marginpar{証明は\Cref{proof:#1}.}}
\newenvironment{proofof}[1]{\begin{numberedproof}[\Cref{statement:#1}]\label{proof:#1}}{\end{numberedproof}}
% misc (command)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
