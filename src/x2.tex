...
\newcommand{\seealsoquiz}[1]{\marginpar{\Cref{#1}は関連する問題である.}}
\newcommand{\seealsoQuiz}[1]{\marginpar{\Cref{#1}$\gets$}}
\newcommand{\Seealsoquiz}[1]{\marginpar{$\to$\Cref{#1}}}
